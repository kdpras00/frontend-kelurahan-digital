...
<template>
  <div class="card flex flex-col gap-6 rounded-3xl p-6 bg-white">
    <div class="flex items-center w-full">
      ...
      <div class="flex flex-col gap-[6px] w-full ml-4 mr-9">
        ...
        <div class="flex items-center gap-1">
          ...
          <p class="font-medium text-sm text-desa-secondary">
            Registration:
            <span class="font-medium text-base text-desa-dark-green" v-if="item.is_active">
              Open
            </span>
      ...
      >
        <span class="font-medium text-white" v-if="user === 'lurah'">Manage</span>
      ...
      <div class="flex items-center gap-3">
        ...
        <div class="flex flex-col gap-1">
          <p class="font-semibold text-lg leading-5 text-desa-blue">
            {{ item.event_participants?.length }} Warga
          </p>
