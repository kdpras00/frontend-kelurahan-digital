...
<template>
  <div id="Header" class="flex items-center justify-between">
    <div class="flex flex-col gap-2">
      ...
      <h1 class="font-semibold text-2xl">Tambah Job Vacancy</h1>
    </div>
  </div>
    ...
    <div class="shrink-0 rounded-3xl p-6 bg-white flex flex-col gap-6 h-fit">
      <section id="Thumbnail" class="flex items-center justify-between">
        ...
        <div class="flex-1 flex items-center justify-between">
          ...
          >
            <img
              v-if="jobVacancy.thumbnail_url"
              id="Photo"
              :src="jobVacancy.thumbnail_url"
              alt="image"
              class="size-full object-cover"
            />
            <span v-else class="text-xs text-desa-secondary text-center px-2">Belum ada thumbnail</span>
          </div>
          <div class="relative">
            <input
              id="File"
 ...
 Jelaskan detail lowongan
      ...
      <section id="Buttons" class="flex items-center justify-end gap-4">
        <RouterLink :to="{ name: 'job-vacancy' }">
          <div
